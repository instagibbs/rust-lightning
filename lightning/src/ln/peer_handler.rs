		...
		match message {
			...
			Message::TeleportCompleteAck(msg) => {
				self.message_handler
					.chan_handler
					.handle_teleport_complete_ack(their_node_id, &msg);
			},
				...
				let mut handle_event = |event, from_chan_handler| {
					match event {
						...
						MessageSendEvent::SendTeleportInit { ref node_id, msg } => {
							log_debug!(WithContext::from(&self.logger, Some(*node_id), Some(msg.channel_id), None), "Handling SendTeleportInit event in peer_handler for node {} for channel {}",
									node_id,
									&msg.channel_id);
						...
						MessageSendEvent::SendTeleportAck { ref node_id, msg } => {
							log_debug!(WithContext::from(&self.logger, Some(*node_id), Some(msg.channel_id), None), "Handling SendTeleportAck event in peer_handler for node {} for channel {}",
									node_id,
									&msg.channel_id);
						...
						MessageSendEvent::SendTeleportAbort { ref node_id, msg } => {
							log_debug!(WithContext::from(&self.logger, Some(*node_id), Some(msg.channel_id), None), "Handling SendTeleportAbort event in peer_handler for node {} for channel {}",
									node_id,
									&msg.channel_id);
						...
						MessageSendEvent::SendTeleportComplete { ref node_id, msg } => {
							log_debug!(WithContext::from(&self.logger, Some(*node_id), Some(msg.channel_id), None), "Handling SendTeleportComplete event in peer_handler for node {} for channel {}",
									node_id,
									&msg.channel_id);
						...
						MessageSendEvent::SendTeleportCompleteAck { ref node_id, msg } => {
							log_debug!(WithContext::from(&self.logger, Some(*node_id), Some(msg.channel_id), None), "Handling SendTeleportCompleteAck event in peer_handler for node {} for channel {}",
									node_id,
									&msg.channel_id);
